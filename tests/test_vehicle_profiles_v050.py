    ...
    with TestClient(main.app) as client:
        ...
        run = client.post(
            ...
            json={
                ...
                "transport": "http",
                "random_seed": 17,
                "parameter_overrides": {"kinematics": {"maximum_speed_mps": 1.75}},
        ...
        assert (
            payload["effective_parameters"]["kinematics"]["maximum_speed_mps"] == 1.75
        )
        assert (
            payload["effective_parameters"]["operational_limits"]["maximum_depth_m"]
            == 300.0
        )
...
def test_vehicle_types_generate_distinct_motion() -> None:
    ...
    ugv = motion_state(
        7.0, scenario, "GROUND_VEHICLE", {"kinematics": {"maximum_speed_mps": 4.0}}
    )
    ...
    auv = motion_state(
        ...
        "AUV",
        {
            "kinematics": {"maximum_speed_mps": 2.4},
            "operational_limits": {"maximum_depth_m": 300.0},
        },
    )
