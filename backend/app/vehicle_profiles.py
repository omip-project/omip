...
VEHICLE_PARAMETER_DEFINITIONS: dict[str, dict[str, dict[str, Any]]] = {
    "GROUND_VEHICLE": {
        ...
        "kinematics.maximum_speed_mps": {
            "unit": "m/s",
            "type": "number",
            "minimum": 0.05,
            "required": True,
        },
        "kinematics.minimum_turning_radius_m": {
            "unit": "m",
            "type": "number",
            "minimum": 0.1,
            "required": True,
        },
        "kinematics.maximum_steering_angle_deg": {
            "unit": "deg",
            "type": "number",
            "minimum": 1.0,
            "maximum": 89.0,
        ...
        "dynamics.maximum_acceleration_mps2": {
            "unit": "m/s2",
            "type": "number",
            "minimum": 0.01,
            "required": True,
        },
        "dynamics.maximum_deceleration_mps2": {
            "unit": "m/s2",
            "type": "number",
            "minimum": 0.01,
            "required": True,
        ...
        "operational_limits.maximum_slope_deg": {
            "unit": "deg",
            "type": "number",
            "minimum": 0.0,
            "maximum": 90.0,
    ...
    "UAV": {
        ...
        "kinematics.maximum_climb_rate_mps": {
            "unit": "m/s",
            "type": "number",
            "minimum": 0.01,
            "required": True,
        },
        "kinematics.maximum_descent_rate_mps": {
            "unit": "m/s",
            "type": "number",
            "minimum": 0.01,
            "required": True,
        },
        "dynamics.maximum_yaw_rate_deg_s": {
            "unit": "deg/s",
            "type": "number",
            "minimum": 0.1,
            "required": True,
        ...
        "operational_limits.maximum_altitude_m": {
            "unit": "m",
            "type": "number",
            "minimum": 1.0,
            "required": True,
        },
        "operational_limits.maximum_wind_speed_mps": {
            "unit": "m/s",
            "type": "number",
            "minimum": 0.0,
            "required": True,
    ...
    "AUV": {
        ...
        "kinematics.maximum_ascent_rate_mps": {
            "unit": "m/s",
            "type": "number",
            "minimum": 0.01,
            "required": True,
        ...
        "operational_limits.maximum_depth_m": {
            "unit": "m",
            "type": "number",
            "minimum": 1.0,
            "required": True,
        },
        "operational_limits.minimum_return_battery_percent": {
            "unit": "%",
            "type": "number",
            "minimum": 0.0,
            "maximum": 100.0,
    ...
    "USV": {
        ...
        "kinematics.maximum_reverse_speed_mps": {
            "unit": "m/s",
            "type": "number",
            "minimum": 0.0,
            "required": True,
        },
        "dynamics.maximum_turn_rate_deg_s": {
            "unit": "deg/s",
            "type": "number",
            "minimum": 0.1,
            "required": True,
        ...
        "operational_limits.maximum_wave_height_m": {
            "unit": "m",
            "type": "number",
            "minimum": 0.0,
            "required": True,
...
BUILT_IN_PROFILES: list[dict[str, Any]] = [
    {
        ...
        "parameters": {
            ...
            "kinematics": {
                ...
                "minimum_turning_radius_m": 2.5,
                "maximum_steering_angle_deg": 32.0,
            },
            "dynamics": {
                "maximum_acceleration_mps2": 1.8,
                "maximum_deceleration_mps2": 4.5,
            },
    ...
    },
    {
        ...
        "parameters": {
            "geometry": {
                ...
                "width_m": 0.55,
                "height_m": 0.55,
                "safety_margin_m": 0.75,
            },
            "kinematics": {
                "maximum_speed_mps": 2.4,
                "maximum_ascent_rate_mps": 0.7,
                "maximum_descent_rate_mps": 0.9,
            },
            "dynamics": {"maximum_pitch_deg": 30.0, "drag_coefficient": 0.42},
            "energy": {"battery_capacity_wh": 5200.0},
            "operational_limits": {
                "maximum_depth_m": 300.0,
                "minimum_return_battery_percent": 20.0,
            },
        },
    },
    {
    ...
    for path, definition in definitions.items():
        ...
        if definition.get("type") == "number":
            if isinstance(value, bool) or not isinstance(value, (int, float)):
                ...
                continue
            if definition.get("minimum") is not None and float(value) < float(
                definition["minimum"]
            ):
                errors.append(f"{path} must be >= {definition['minimum']}")
            if definition.get("maximum") is not None and float(value) > float(
                definition["maximum"]
            ):
